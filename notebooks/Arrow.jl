...
## The Emotikon data
The [SMLP2021 repository](https://github.com/RePsychling/SMLP2021) contains a version of the data from Fühner, Golle, Granacher, & Kliegl (2021) in `notebooks/data/fggk21.arrow`.  After that file was created there were changes in the master RDS file on the [osf.io site](https://osf.io/2d8rj/) for the project.  We will recreate the Arrow file here then split it into two separate tables, one with a row for each child in the study and one with a row for each test result.
...
# ╔═╡ aa83869a-fd2c-42cd-8044-fe3c604562fb
md"""
...
# ╔═╡ d09f156d-5fca-4766-a589-a745857bfa2e
fn = Downloads.download("https://osf.io/xawdb/download?version=2");

# ╔═╡ c4f66bdf-4664-4558-ac8f-a63d81d078c6
dfrm = rcopy(R"readRDS($fn)")

# ╔═╡ 3eca07b1-71bc-432c-b469-0df59565f10d
md"""
We can see what is meant by "CategoricalArrays and Pluto don't play well together".

Now write this file as a Arrow file and read it back in.
"""

# ╔═╡ 7d5ec07e-2301-404f-8105-769f68bb7fbe
tbl = Arrow.Table(Arrow.write("./data/fggk21.arrow", dfrm; compress=:zstd))

# ╔═╡ 205207b5-3a0b-43f0-bae2-5c7736f52074
filesize("./data/fggk21.arrow")
...
# ╔═╡ 3a7af314-dc33-4691-8f79-33818f238693
md"""
...
# ╔═╡ 2ae85f30-cf46-4cf9-b68e-1e18253997b2
...
# ╔═╡ 01967463-4218-48c0-b1fe-d36918c16e4a
md"""
!!! note
    This data frame is called `Child1`, not `Child` because Pluto objects to having the same name defined in different places.
"""
...
# ╔═╡ 86606849-fcde-4497-85d0-d795546085fc
md"""
...
Later we can group the table according to this `:n` to look at properties of `:Child` by `:n`.
"""
...
They can be accessed within Julia using the `RCall` and `PyCall` packages.
"""
