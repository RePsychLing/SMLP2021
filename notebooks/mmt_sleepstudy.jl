...
md"""
First attach the MixedModels package and other packages for plotting.  The CairoMakie package allows the Makie graphics system to generate high quality static images.  Activate that package with the SVG (Scalable Vector Graphics) backend.

Multiple Julia statements in the same Pluto cell must be enclosed in a `begin ... end` block.
"""
...
# ╔═╡ fdf62bc0-142e-44ef-b0c7-bbc96c37cf11
md"""
To display the data we use a multi-panel plot previously created with the `lattice` package in `R`.
"""

# ╔═╡ 632c336e-ef93-474c-8bf4-d2d669e3b7db
Resource("https://github.com/palday/MixedModelsMakie.jl/blob/main/examples/sleepxy.svg?raw=true")
...
# ╔═╡ ad50804e-b88c-4f8d-a706-b2320a713e2e
md"""
...
# ╔═╡ 40674106-a845-4167-887c-e50fdd92fa38
caterpillar(m1)

# ╔═╡ 30eb0c7e-f2c9-4b96-a7b4-e00163d69b3d
md"""
This plot reinforces the conclusion that there is little correlation between the random effect for intercept and the random effect for slope.
"""
...
# ╔═╡ 77a73930-87c2-46aa-9a0d-670069202e15
let mods = [m2, m1]
	DataFrame(
		model=[:m2, :m1],
		pars=dof.(mods),
...
# ╔═╡ 9a32b23a-701f-417d-9a3d-1d1cbb5cd59e
md"""
...
# ╔═╡ cc4f2c40-821d-4fec-8fba-4f5eae01be6d
md"""
...
begin
	...
	m1bstp = parametricbootstrap(rng, 2000, m1; hide_progress=true)
...
describe(@subset(allpars, :type=="ρ"))
...
md"""
Finally, density plots for the variance components (but on the scale of the standard deviation) show reasonable symmetry.
"""
...
git-tree-sha1 = "436983ae8762ea31c74ba8b76faf72ce6ec7aef1"
